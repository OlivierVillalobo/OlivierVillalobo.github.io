...
$header = "From: <form action = "https://formspree.io/olivier.villalobo@gmail.com" method = "POST" />"\n\; //C'est l'adresse email à partir de laquelle le message généré sera. Nous vous recommandons d’utiliser quelque chose comme noreply@votredomaine.com.
